...
112 tests covering: evidence pipeline (resolve, parse, chunk, ingest), search, remove, validate (evidence, vocabulary, source pages), lint, import (BibTeX, ZIP), export, external search, maintain, PDF handling, workflow integration.
